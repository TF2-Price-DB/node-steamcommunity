...
SteamCommunity.DEFAULT_USER_AGENT = 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/138.0.0.0 Safari/537.36';
SteamCommunity.DEFAULT_DOCUMENT_ACCEPT = 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8';
...
function SteamCommunity(options) {
	...
	this._userAgent = options.userAgent || SteamCommunity.DEFAULT_USER_AGENT;
